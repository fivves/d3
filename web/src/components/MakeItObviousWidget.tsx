...
const DEFAULT_ITEMS: ChecklistItem[] = [
  ...
  {
    id: 'env-trigger-sweep',
    title: 'Trigger sweep',
    description: 'Remove or hide obvious triggers from your space.',
    category: 'Environment',
    icon: '🧹',
  },
  {
    ...
    title: 'Protein ready',
    description: 'Stage a quick protein snack for the next craving window.',
    category: 'Nutrition',
    icon: '🍳',
  },
  {
  ...
  },
  {
    id: 'social-checkin',
    title: 'Check‑in text',
    description: 'Send a quick “checking in” text to a trusted person.',
    category: 'Social',
    icon: '💬',
  },
  {
    id: 'mind-if-then',
    title: 'If‑Then card',
    description: 'Write one If‑Then plan for a likely trigger today.',
    category: 'Mind',
    icon: '🧠',
  },
];
...
export default function MakeItObviousWidget() {
  ...
  return (
    <div>
      ...
      <div className="sub" style={{ marginBottom: 8 }}>Daily checklist resets at midnight. Complete all to earn +5 points.</div>
      <div className="list">
        {items.map((it, idx) => (
      ...
      <div style={{ display:'flex', gap:8, marginTop:12 }}>
        <div className="pill">{allDone ? 'All done! +5 points will be awarded' : 'Complete all to earn +5 points'}</div>
      </div>
    </div>
  );
}
